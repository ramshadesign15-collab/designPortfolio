...
const VARIANTS = {
  ...
  clip: { hidden: { opacity: 0, y: 36 }, show: { opacity: 1, y: 0 } },
} as const
...
export function Reveal({ children, variant = 'up', delay = 0, duration = 0.75, amount = 0.2, once = true, className }: RevealProps) {
  return (
